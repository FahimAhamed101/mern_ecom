...
router.post("/create-product", async (req, res) => {
  ...
  router.get("/:id", async (req, res) => {
    try {
      ...
      res.status(400).send({ message: "Failed to fetch product" });
    }
  });
  ...
  router.patch("/update-product/:id", verifyToken, verifyAdmin, async (req, res) => {
    try {
      ...
      res.status(400).send({ message: "Failed to update the product" });
    }
  });
  ...
  router.get("/related/:id", async (req, res) => {
    try {
      ...
      res.status(400).send({ message: "Failed to fetch related products" });
    }
  });
